"""PSPNet: Pyramid Scene Parsing Network (Zhao et al., 2017) for SOTA comparison.

Uses segmentation_models_pytorch (SMP) with a ResNet50 encoder and PSP module.
...
class PSPNet(nn.Module):
    """PSPNet with ResNet50 encoder (SMP).
