"""DeepLabV3+ (Chen et al., 2018) for SOTA comparison.

Uses segmentation_models_pytorch (SMP) with a ResNet50 encoder, ASPP module,
and a lightweight decoder with skip connections from the low-level features.
One independent head per output chart.
"""
...
class DeepLabV3Plus(nn.Module):
    """DeepLabV3+ with ResNet50 encoder (SMP).
